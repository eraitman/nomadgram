...
from nomadgram.users import serializers as users_serailizers
...
class LikeImage(APIView):
    ...
    def get(self,request,image_id,format=None):
        ...
        serializer = users_serailizers.ListUserSerializer(users, many=True)
    ...
    def post(self,request, image_id, format=None):
        ...
        try:
            ...
            #preexisiting_like.delete()  -> 잘못된 디자인원칙: Post에서 삭제 시도
...
class CommentOnImage(APIView):
    ...
    def post(self, request, image_id, format=None):
        ...
        if serializer.is_valid():
            ...
            return Response(data=serializer.error, status = stuats.HTTP_400_BAD_REQUEST)
